    ...
    <main class="home-page-content">
      ...
      <div class="common-banner">
        ...
        <div class="text-content">
          <h3 class="sub-title">Get the best help you will need with our</h3>
          <h1 class="title">Live Master Class</h1>
          <p class="text">
            Are you struggling with your exam? Did you fail on your previous
      ...
      >
        <div class="text-content">
          <h3 class="section-title">What is a Live Master Class?</h3>
          <p class="section-text mt-5">
            Master Class offers a selection of high-quality online courses
          ...
          <div class="bottom-content">
            <p>
              Whether you are studying for a PMHNP, FNP [ ANCC, AANP ], or NCLEX
      ...
      <div class="date-time-section section-padding-x section-padding-y">
        ...
        <p class="section-text text-center mt-3">
          Enroll in one of the available classes below, choose the right one for
          you.
        </p>
