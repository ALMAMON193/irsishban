    ...
    <main class="home-page-content">
        ...
        <div class="common-banner">
            ...
            <div class="text-content">
                <p class="text">Are you a nurse practitioner struggling and feeling overwhelmed with exam preparation?
                </p>
                <h3 class="sub-title mt-2">Pass the NP exam on your first try with our</h3>
                <h1 class="title">Live Final Coaching Review🎓</h1>
                <p class="text">
                    A proven exam prep with a 99% passing guarantee!
                </p>
                <div class="mt-5">
                    <a href="./course-details.html" class="common-btn banner-btn">Enroll Now & Ace Your Exam</a>
                </div>
            </div>
        </div>
        <!-- banner end -->
        ...
        <div class="question-bank-section section-with-img section-padding-x section-padding-y ">
            ...
            <div class="text-content">
                ...
                <p class="section-text mt-4">
                    ...
                    course?
                    PASS is the review center you've been searching for! Whether you're feeling swamped or just starting
                    to
                    look for the perfect review course, you've come to the right place, this is an opportunity for you!
                </p>
                <p class="section-text mt-3">
                    My course is designed to simplify your study process, allowing you to focus on what's truly
                    important.
                    I'm here to guide you every step of the way, offering clear guidance to streamline your studies.
                </p>
                <p class="section-text mt-3">
                    I understand the pressure and stress exams can bring; I've been in your shoes. Preparing for the
                    exam is
                    hard and can cause anxiety. That's why I'm committed to making your preparation journey as smooth
                    and
                    stress-free as possible. I’ve been doing this for almost 10 years; I've helped thousands of students
                    like you. I want to help you overcome it and make you feel comfortable and confident.
                </p>
                <p class="section-text mt-3">
                    Join the ranks of students who've successfully passed their ANCC/AANP board exams with my help.
                    Together, we'll not only prepare you for the exam but also ensure you're confident and ready to
                    succeed.
                </p>
                <p class="section-text mt-3">
                    Don't let exam prep anxiety hold you back. Embrace this opportunity to become more comfortable,
        ...
        <div class="section-padding-x section-padding-y ">
            ...
            <p class="section-text text-center mt-3 ">
                Our Live Final Coaching Review is designed to offer an in-depth understanding and hands-on <br>
                experience,
                ensuring you’re fully equipped to excel in your exams.
            </p>
            ...
            <div class="coaching-benefits mt-5">
                ...
                <div class="item">
                    ...
                    confidently
                    tackle any question. Unravel the exam's secrets and dominate every domain.
                </div>
                <div class="item">
            ...
            <div class="mt-5 d-flex justify-content-center">
                <a href="" class="common-btn enroll-now-btn">Enroll Now</a>
            </div>
        </div>
        ...
        <div class="coaching-schedule-container section-padding-x section-padding-y ">
            <div class="section-title text-center ">
                So what exactly you will learn when you take the live class?
        ...
        <div class="coaching-review-bottom-sections bg-white section-padding-x section-padding-y ">
            ...
            <div class="exam-schedule-container section-padding-y ">
                <div class="section-title text-center">Ready to PASS your exam?</div>
                <div class="section-text text-center mt-4 fw-bold ">
                    Take your first step! Choose your preferred schedule below
                </div>
                <div class="section-text mt-4 text-center">
                    Enroll in one of the available classes below, choose the right one for you.
                </div>
                <div class="section-text mt-4 text-center">
                    Spaces in our program are limited and fill up fast. Don't miss this chance to boost your confidence
                    <br>
                    and knowledge for the PMHNP exam.
                </div>
