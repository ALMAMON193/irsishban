                           ...
                           <ul class="slide-menu">
                               ...
                               <li class="sub-slide">
                                   ...
                                   <ul class="sub-slide-menu">
                                       ...
                                       <li><a class="sub-slide-item" href="{{ route('lastreview.get.strated.section') }}">Get Started Section</a></li>
                               ...
                               <li class="sub-slide">
                                   ...
                                   <ul class="sub-slide-menu">
                                       ...
                                       <li><a class="sub-slide-item" href="{{ route('final.review.coaching.get.strated.section') }}">Get started Section</a></li>
                                       <li><a class="sub-slide-item" href="{{ route('final.review.coaching.schedule.section') }}">Schedule Section</a></li>
                                   </ul>
                               </li>
                               <li class="sub-slide">
                                   <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                                   ...
                                   <ul class="sub-slide-menu">
                                       ...
                                       <li><a class="sub-slide-item" href="{{ route('course.expect.section') }}">Expect Section</a></li>
